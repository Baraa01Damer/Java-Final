...
public class clsLion extends clsAnimal implements animalInterface{
    ...
    public clsLion(String type, int lbs, String color, String name)
    {
        super(type, lbs);
    ...
    {
        String s = "The " + this.animalColor + " " + this.animalType + " is named " + this.animalName + ", and weighs " + this.animallbs + " lbs.";
        return s;
    }
